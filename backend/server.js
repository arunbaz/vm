...
const db = mysql.createConnection({
  ...
  user: process.env.DB_USER || 'root', // Use your MySQL username
  password: process.env.DB_PASSWORD ||'password123', // Use your MySQL password
  database: process.env.DB_NAME || 'events_db', // Ensure the database exists in MySQL
});
